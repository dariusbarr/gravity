...
public class PendulumRunner  {
	...
	GravityConstant gravityConstant = new GravityConstant(25); //ADJUST VALUE HERE
	...
	RegularPendulum rp = new RegularPendulum (sLen, pMass, theta0, delta,gravityConstant);
	SimplePendulum sp = new SimplePendulum (sLen, pMass, theta0,gravityConstant);
	RegularPendulum rpCoarse = 
	    new RegularPendulum (sLen, pMass, theta0, .1,gravityConstant);
